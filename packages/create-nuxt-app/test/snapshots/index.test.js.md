...
## verify features: Axios - Promise based HTTP client, Pulsar Sass - Sass integration, Progressive Web App (PWA), Content - Git-based headless CMS
...
## verify features: Pulsar Sass - Sass integration
...
## verify linter: ESLint, Prettier, Lint staged files, Pulsar commits, StyleLint, Commitlint
...
## verify devTools: jsconfig.json (Recommended for VS Code if you're not using typescript), Pulsar VS Code, Semantic Pull Requests, Dependabot (For auto-updating dependencies, GitHub only)
...
## verify devTools: Pulsar VS Code
